...
export const DisplayPanel = ({ track, currentTime, duration, isPlaying }: DisplayPanelProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
      ...
      <div className="flex items-center justify-center">
        <div className={`
          relative w-24 h-24 md:w-32 md:h-32 rounded-xl overflow-hidden border-2 border-primary/30
